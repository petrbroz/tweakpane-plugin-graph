...
function createSvgIconElement(document, iconId) {
    const elem = document.createElementNS(SVG_NS$1, 'svg');
...
class GraphView {
    constructor(doc, { value, viewProps, formatter }) {
